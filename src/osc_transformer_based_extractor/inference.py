...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Perform inference using a pre-trained sequence classification model. (local or hugging face)"
    )
    parser.add_argument(
        "--question", type=str, required=True, help="The question for inference."
    )
    parser.add_argument(
        "--context", type=str, required=True, help="The context to be analyzed."
    )
    parser.add_argument(
        "--model_path",
        type=str,
        required=True,
        help="Path to the pre-trained model. (local or hugging face)",
    )
    parser.add_argument(
        "--tokenizer_path",
        type=str,
        required=True,
        help="Path to the tokenizer to the pre-trained model. (local or hugging face)",
    )
