...
from osc_transformer_based_extractor.main import app  # Import your Typer application instance
...
def test_fine_tune_command(mock_check_output_dir, mock_check_csv_columns, mock_fine_tune_model):
...
def test_perform_inference_command(mock_check_model_and_tokenizer_path, mock_check_question_context, mock_get_inference):
    ...
    mock_check_model_and_tokenizer_path.return_value = None  # Mock return value if needed
...
@patch('osc_transformer_based_extractor.inference.check_question_context')
@patch('osc_transformer_based_extractor.inference.check_model_and_tokenizer_path')
def test_perform_inference_command_value_error(mock_check_model_and_tokenizer_path, mock_check_question_context, mock_get_inference):
